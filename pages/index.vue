  ...
  data() {
    return {
      ...
      clients: [
        ...
        {src: 'BEO.jpg', link: '/blog/'},
        {src: 'BCA.png', link: '/blog/'},
        {src: 'ChildreninNeed.png', link: '/blog/'},
        {src: 'Cochlear.png', link: '/blog/'},
        {src: 'Complex.jpg', link: '/blog/'},
        {src: 'EIF.png', link: '/blog/'},
        {src: 'Fair4All.png', link: '/blog/'},
        {src: 'FinancialTimes.png', link: '/blog/'},
        {src: 'GambleAware.png', link: '/blog/'},
        {src: 'GLA.png', link: '/blog/'},
        {src: 'HMP.jpg', link: '/blog/'},
        {src: 'ITVX.png', link: '/blog/'},
        {src: 'Macmillan.png', link: '/blog/'},
        {src: 'MHB.png', link: '/blog/'},
        {src: 'ONS.png', link: '/blog/'},
        {src: 'PS2Go.png', link: '/blog/'},
        {src: 'SOAS.png', link: '/blog/'},
        {src: 'SueRyder.png', link: '/blog/'},
        {src: 'TBC.jpg', link: '/blog/'},
        {src: 'TBCurr.jpg', link: '/blog/'},
        {src: 'TBT.jpg', link: '/blog/'},
        {src: 'TSV.png', link: '/blog/'},
        {src: 'UPD.jpg', link: '/blog/'},
        {src: 'w00t.png', link: '/blog/'},
        {src: 'WellcomeTrust.png', link: '/blog/'},
        {src: 'YourStory.png', link: '/blog/'}
      ],
      insights: [
        {src: 'bbc.png'},
        {src: 'glamour.png'},
